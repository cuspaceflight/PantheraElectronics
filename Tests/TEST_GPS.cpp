...
#if !defined(NMEAGPS_PARSE_GGA) & !defined(NMEAGPS_PARSE_GLL) & !defined(NMEAGPS_PARSE_GSA)        \
    & !defined(NMEAGPS_PARSE_GSV) & !defined(NMEAGPS_PARSE_RMC) & !defined(NMEAGPS_PARSE_VTG)      \
